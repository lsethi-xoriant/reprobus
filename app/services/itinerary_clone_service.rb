class ItineraryCloneService
  def self.clone(params)
    ...
    make_copy(original_itinerary, start_date, old_date)
  end

  private

  def self.make_copy(original_itinerary, start_date, old_date)
    ...
    itinerary_copy.enquiry = original_itinerary.enquiry
