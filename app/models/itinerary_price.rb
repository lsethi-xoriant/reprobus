...
class ItineraryPrice < ActiveRecord::Base
  ...
  def new_setup
    ...
    self.itinerary_price_items.build({description: self.itinerary.name, start_date: self.itinerary.start_date, end_date: self.itinerary.end_date, quantity: self.itinerary.num_passengers })
